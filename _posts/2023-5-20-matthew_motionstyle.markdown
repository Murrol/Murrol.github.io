...
---
We propose a flexible motion style extraction and injection method from a generative perspective to solve the motion stylization task. It is versatile, allowing the learning of probabilistic style space from labeled/unlabeled motions, providing notable generalization ability in synthetic motion stylization as well.